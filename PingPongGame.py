...
def outerloop():
    def innerloop():
        ...
        def back():
            ...
            outerloop()
        button2 = Button(window, text="Exit Game", font=("Times Bold", 25), command=back, fg="#FF0000")
        button2.pack()
    ...
    welcomemessage.pack()
    aboutsection1 = Label(window, text="Player 1 (Left) will use 'W' and 'S'", font=("Times Bold", 20), fg="#DCB2CD")
    aboutsection1.pack(side=LEFT)
    aboutsection2 = Label(window, text="Player 2 (Right) will use '↑' and '↓'", font=("Times Bold", 20), fg="#DCB2CD")
